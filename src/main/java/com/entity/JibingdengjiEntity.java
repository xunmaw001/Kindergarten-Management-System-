...
public class JibingdengjiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JibingdengjiEntity() {
		
	}
	
	public JibingdengjiEntity(T t) {
		try {
	 ...
	 * 设置：疾病原因
	 */
	public void setJibingyuanyin(String jibingyuanyin) {
		this.jibingyuanyin = jibingyuanyin;
	}
	/**
	 * 获取：疾病原因
	 */
	public String getJibingyuanyin() {
		return jibingyuanyin;
	}
	/**
	 * 设置：疾病详情
	 */
