...
public class HuiyijiluController {
    ...
    public R page(@RequestParam Map<String, Object> params,HuiyijiluEntity huiyijilu, 
		...
		if(tableName.equals("jiaoshi")) {
			huiyijilu.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,HuiyijiluEntity huiyijilu, 
		HttpServletRequest request){
        EntityWrapper<HuiyijiluEntity> ew = new EntityWrapper<HuiyijiluEntity>();
