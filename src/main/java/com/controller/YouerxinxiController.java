...
public class YouerxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YouerxinxiEntity youerxinxi, 
		...
		if(tableName.equals("jiaoshi")) {
			youerxinxi.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiazhang")) {
			youerxinxi.setJiazhangzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YouerxinxiEntity youerxinxi, 
		HttpServletRequest request){
        EntityWrapper<YouerxinxiEntity> ew = new EntityWrapper<YouerxinxiEntity>();
