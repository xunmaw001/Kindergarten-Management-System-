...
public class YouerqingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,YouerqingjiaEntity youerqingjia, 
		...
		if(tableName.equals("jiaoshi")) {
			youerqingjia.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiazhang")) {
			youerqingjia.setJiazhangzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YouerqingjiaEntity youerqingjia, 
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date qingjiashijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date qingjiashijianend,
		HttpServletRequest request){
        EntityWrapper<YouerqingjiaEntity> ew = new EntityWrapper<YouerqingjiaEntity>();
