    ...
    <el-tabs tab-position="left" :style='{"border":"2px solid #dbd9f4","padding":"20px","margin":"8px 4px 4px 4px","borderRadius":"16px","background":"#fff"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="家长账号" prop="jiazhangzhanghao">
            <el-input v-model="sessionForm.jiazhangzhanghao" placeholder="家长账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="家长姓名" prop="jiazhangxingming">
            <el-input v-model="sessionForm.jiazhangxingming" placeholder="家长姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="jiazhangtouxiangHandleAvatarSuccess">
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="孩子姓名" prop="haizixingming">
            <el-input v-model="sessionForm.haizixingming" placeholder="孩子姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="联系方式" prop="lianxifangshi">
            <el-input v-model="sessionForm.lianxifangshi" placeholder="联系方式" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="班级名称">
            <el-select v-model="sessionForm.banjimingcheng" placeholder="请选择班级名称" @change="banjimingchengChange" >
              <el-option v-for="(item, index) in dynamicProp.banjimingcheng" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiazhang'" label="教师工号" prop="jiaoshigonghao">
            <el-input v-model="sessionForm.jiaoshigonghao" placeholder="教师工号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiaoshi'" label="教师工号" prop="jiaoshigonghao">
            <el-input v-model="sessionForm.jiaoshigonghao" placeholder="教师工号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiaoshi'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiaoshi'" label="教师姓名" prop="jiaoshixingming">
            <el-input v-model="sessionForm.jiaoshixingming" placeholder="教师姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiaoshi'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
          ...
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiaoshi'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiaoshi'" label="班级名称">
            <el-select v-model="sessionForm.banjimingcheng" placeholder="请选择班级名称" disabled>
              <el-option v-for="(item, index) in dynamicProp.banjimingcheng" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"80%","padding":"10px","margin":"4px auto","background":"none"}' v-if="userTableName=='jiaoshi'" label="联系电话" prop="lianxidianhua">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('jiazhang' == this.userTableName) {
        this.$set(this.sessionForm, 'haizixingming', null);
      }
      if ('jiazhang' == this.userTableName) {
        this.$set(this.sessionForm, 'lianxifangshi', null);
      }
      if ('jiazhang' == this.userTableName) {
        this.$set(this.sessionForm, 'banjimingcheng', null);
      }
      if ('jiazhang' == this.userTableName) {
    ...
    methods: {
      init() {
        if ('jiazhang' == this.userTableName) {
          this.dynamicProp.xingbie = '男,女'.split(',');
				...
				if ('jiazhang' == this.userTableName) {
          this.$http.get('option/banjixinxi/banjimingcheng', {emulateJSON: true}).then(res => {
            if (res.data.code == 0) {
              this.dynamicProp.banjimingcheng = res.data.data;
            }
          });
        }    
        if ('jiaoshi' == this.userTableName) {
      ...
      banjimingchengChange(value) {
        this.$http.get('follow/banjixinxi/banjimingcheng', {params: {columnValue: value}}).then(res => {
          if (res.data.code == 0) {
            this.sessionForm.jiaoshigonghao = res.data.data.jiaoshigonghao;
          }
        });
      },
      getSession() {
      ...
      jiazhangtouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('jiazhang' == this.userTableName) {
