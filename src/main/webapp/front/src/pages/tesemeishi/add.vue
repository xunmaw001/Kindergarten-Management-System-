...
<div :style='{"border":"2px solid #dbd9f4","padding":"20px","margin":"10px auto","borderRadius":"8px","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="菜品名称" prop="caipinmingcheng">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}'  label="菜品类别" prop="caipinleibie">
            <el-select v-model="ruleForm.caipinleibie" placeholder="请选择菜品类别"  >
              <el-option
                  v-for="(item,index) in caipinleibieOptions"
                  :key="index"
                  :label="item"
                  :value="item">
              </el-option>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="特色" prop="tese">
            <el-input v-model="ruleForm.tese" 
                placeholder="特色" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="主食材" prop="zhushicai">
            <el-input v-model="ruleForm.zhushicai" 
                placeholder="主食材" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="菜单时间" prop="caidanshijian" >
              <el-date-picker
                  format="yyyy 年 MM 月 dd 日"
                  value-format="yyyy-MM-dd"
                  v-model="ruleForm.caidanshijian" 
                  type="date"
                  placeholder="菜单时间">
              </el-date-picker> 
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"0"}' label="菜品详情" prop="caipinxiangqing">
            <editor 
...
<script>
  export default {
    ...
    created() {
      ...
      this.ruleForm.caidanshijian = this.getCurDate()
    },
    methods: {
      getMakeZero(s) {
          return s < 10 ? '0' + s : s;
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='caipinleibie'){
              this.ruleForm.caipinleibie = obj[o];
              this.ro.caipinleibie = true;
              continue;
            }
            if(o=='tese'){
            ...
            if(o=='zhushicai'){
              this.ruleForm.zhushicai = obj[o];
              this.ro.zhushicai = true;
              continue;
            }
            ...
            if(o=='caidanshijian'){
              this.ruleForm.caidanshijian = obj[o];
              this.ro.caidanshijian = true;
              continue;
            }
            if(o=='thumbsupnum'){
