<template>
	<div class="addEdit-block" :style='{"padding":"30px 30px 30px 240px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20220805/c242e6fd2047434bb1e519427e59e925.png)","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="费用编号" prop="feiyongbianhao">
					<el-input v-model="ruleForm.feiyongbianhao" placeholder="费用编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.feiyongbianhao" label="费用编号" prop="feiyongbianhao">
					<el-input v-model="ruleForm.feiyongbianhao" placeholder="费用编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="费用名称" prop="feiyongmingcheng">
					<el-input v-model="ruleForm.feiyongmingcheng" placeholder="费用名称" clearable  :readonly="ro.feiyongmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="费用名称" prop="feiyongmingcheng">
					<el-input v-model="ruleForm.feiyongmingcheng" placeholder="费用名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="费用金额" prop="feiyongjine">
					<el-input v-model="ruleForm.feiyongjine" placeholder="费用金额" clearable  :readonly="ro.feiyongjine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="费用金额" prop="feiyongjine">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="录入时间" prop="lurushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.lurushijian" label="录入时间" prop="lurushijian">
					<el-input v-model="ruleForm.lurushijian" placeholder="录入时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="费用明细" prop="feiyongmingxi">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.feiyongmingxi" label="费用明细" prop="feiyongmingxi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.feiyongmingxi"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='feiyongmingcheng'){
							this.ruleForm.feiyongmingcheng = obj[o];
							this.ro.feiyongmingcheng = true;
							continue;
						}
						if(o=='feiyongjine'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.feiyongmingxi = this.ruleForm.feiyongmingxi.replace(reg,'../../../ssm5umt6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shoufeixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shoufeixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
