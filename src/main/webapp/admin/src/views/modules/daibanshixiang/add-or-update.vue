<template>
	<div class="addEdit-block" :style='{"padding":"30px 30px 30px 240px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20220805/c242e6fd2047434bb1e519427e59e925.png)","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="待办事项" prop="daibanshixiang">
					<el-input v-model="ruleForm.daibanshixiang" placeholder="待办事项" clearable  :readonly="ro.daibanshixiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="待办事项" prop="daibanshixiang">
					<el-input v-model="ruleForm.daibanshixiang" placeholder="待办事项" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="待办时间" prop="daibanshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.daibanshijian" label="待办时间" prop="daibanshijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="事项内容" prop="shixiangneirong">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="事项内容"
					  v-model="ruleForm.shixiangneirong" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shixiangneirong" label="事项内容" prop="shixiangneirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shixiangneirong}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				daibanshixiang : false,
				shixiangneirong : false,
				daibanshijian : false,
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='daibanshixiang'){
							this.ruleForm.daibanshixiang = obj[o];
							this.ro.daibanshixiang = true;
							continue;
						}
						if(o=='shixiangneirong'){
							this.ruleForm.shixiangneirong = obj[o];
							this.ro.shixiangneirong = true;
							continue;
						}
						if(o=='daibanshijian'){
