<template>
	<div class="addEdit-block" :style='{"padding":"30px 30px 30px 240px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20220805/c242e6fd2047434bb1e519427e59e925.png)","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学年度" prop="xueniandu">
					<el-input v-model="ruleForm.xueniandu" placeholder="学年度" clearable  :readonly="ro.xueniandu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="学年度" prop="xueniandu">
					<el-input v-model="ruleForm.xueniandu" placeholder="学年度" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="成绩" prop="chengji">
					<el-input v-model="ruleForm.chengji" placeholder="成绩" clearable  :readonly="ro.chengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="成绩" prop="chengji">
					<el-input v-model="ruleForm.chengji" placeholder="成绩" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="成绩等级" prop="chengjidengji">
					<el-select :disabled="ro.chengjidengji" v-model="ruleForm.chengjidengji" placeholder="请选择成绩等级" >
						<el-option
							v-for="(item,index) in chengjidengjiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="成绩等级" prop="chengjidengji">
					<el-input v-model="ruleForm.chengjidengji"
						placeholder="成绩等级" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="班级排名" prop="banjipaiming">
					<el-input v-model="ruleForm.banjipaiming" placeholder="班级排名" clearable  :readonly="ro.banjipaiming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="班级排名" prop="banjipaiming">
					<el-input v-model="ruleForm.banjipaiming" placeholder="班级排名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="教师评语" prop="jiaoshipingyu">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jiaoshipingyu" label="教师评语" prop="jiaoshipingyu">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiaoshipingyu"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='xueniandu'){
							this.ruleForm.xueniandu = obj[o];
							this.ro.xueniandu = true;
							continue;
						}
						...
						if(o=='chengjidengji'){
							this.ruleForm.chengjidengji = obj[o];
							this.ro.chengjidengji = true;
							continue;
						}
						if(o=='banjipaiming'){
							this.ruleForm.banjipaiming = obj[o];
							this.ro.banjipaiming = true;
							continue;
						}
						if(o=='jiaoshipingyu'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiaoshipingyu = this.ruleForm.jiaoshipingyu.replace(reg,'../../../ssm5umt6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
