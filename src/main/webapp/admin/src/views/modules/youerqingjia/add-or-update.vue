<template>
	<div class="addEdit-block" :style='{"padding":"30px 30px 30px 240px","backgroundAttachment":"fixed","background":"url(http://codegen.caihongy.cn/20220805/c242e6fd2047434bb1e519427e59e925.png)","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="请假编号" prop="qingjiabianhao">
					<el-input v-model="ruleForm.qingjiabianhao" placeholder="请假编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qingjiabianhao" label="请假编号" prop="qingjiabianhao">
					<el-input v-model="ruleForm.qingjiabianhao" placeholder="请假编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="请假类型" prop="qingjialeixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="请假类型" prop="qingjialeixing">
					<el-input v-model="ruleForm.qingjialeixing"
						placeholder="请假类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="请假事由" prop="qingjiashiyou">
					<el-input v-model="ruleForm.qingjiashiyou" placeholder="请假事由" clearable  :readonly="ro.qingjiashiyou"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="请假事由" prop="qingjiashiyou">
					<el-input v-model="ruleForm.qingjiashiyou" placeholder="请假事由" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="请假天数" prop="qingjiatianshu">
					<el-input v-model="ruleForm.qingjiatianshu" placeholder="请假天数" clearable  :readonly="ro.qingjiatianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="请假天数" prop="qingjiatianshu">
					<el-input v-model="ruleForm.qingjiatianshu" placeholder="请假天数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="请假时间" prop="qingjiashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qingjiashijian" label="请假时间" prop="qingjiashijian">
