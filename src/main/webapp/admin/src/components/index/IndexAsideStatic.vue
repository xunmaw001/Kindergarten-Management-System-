		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"transparent"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					...
					<span :style='{"width":"calc(100% - 54px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>系统首页</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						...
						<span :style='{"width":"calc(100% - 54px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>个人中心</span>
					</template>
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						...
						<span :style='{"width":"calc(100% - 54px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>{{ menu.menu }}</span>
					</template>
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #fff;
				  				  white-space: nowrap;
				  				  background: url(http://codegen.caihongy.cn/20220727/35f308f4ccae453098a7dd058b3d91a0.png) center center no-repeat;
				  				  display: flex;
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: #fff;
						background: url(http://codegen.caihongy.cn/20220727/227fc20604bd464fb6d2f6d9aacc9c12.png) center center no-repeat;
					}
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item:hover {
						padding: 0 40px;
						color: #fff;
						background: linear-gradient(117deg, #4A4EC2 0%, #A4D7F2 100%);
						line-height: 50px;
						height: 50px;
					}
